...
<template>
  <section class="td-toolbar" role="toolbar" aria-label="Chart controls">
    ...
    <div class="td-toolbar__metrics">
      <article v-for="metric in metrics" :key="metric.label" class="td-toolbar__metric">
    ...
    <div class="td-toolbar__controls">
      <label class="td-toolbar__toggle">
        <input :checked="terminalDark" type="checkbox" @change="onTerminalDarkChange" />
        <span>Dark surface</span>
      </label>
      <label class="td-toolbar__toggle">
        <input :checked="useLogScale" type="checkbox" @change="onUseLogScaleChange" />
        <span>Log Y</span>
      </label>
      <label class="td-toolbar__select-wrap">
        ...
        >
          <option v-for="opt in resolutionOptions" :key="opt.id" :value="opt.id">
            {{ opt.label }}
          </option>
        </select>
      </label>
      <label class="td-toolbar__select-wrap">
        ...
        <select :value="drawMode" class="td-toolbar__select" @change="onDrawModeChange">
