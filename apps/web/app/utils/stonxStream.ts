 ...
 * Wire protocol is implemented by Stonx; this file only types and serializes messages.
 */

export const STONX_STREAM_URL_DEFAULT = 'wss://stonx.app/ws/stream'

/** Matches Stonx app client: 30s ping, stale detection beyond ~90s without pong. */
